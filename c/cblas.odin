...
foreign openblas {
	...
	cblas_cdotu :: proc(n: blasint, x: rawptr, incx: blasint, y: rawptr, incy: blasint) -> openblas_complex_float ---
	cblas_cdotc :: proc(n: blasint, x: rawptr, incx: blasint, y: rawptr, incy: blasint) -> openblas_complex_float ---
	cblas_zdotu :: proc(n: blasint, x: rawptr, incx: blasint, y: rawptr, incy: blasint) -> openblas_complex_double ---
	cblas_zdotc :: proc(n: blasint, x: rawptr, incx: blasint, y: rawptr, incy: blasint) -> openblas_complex_double ---
	cblas_cdotu_sub :: proc(n: blasint, x: rawptr, incx: blasint, y: rawptr, incy: blasint, ret: rawptr) ---
	cblas_cdotc_sub :: proc(n: blasint, x: rawptr, incx: blasint, y: rawptr, incy: blasint, ret: rawptr) ---
	cblas_zdotu_sub :: proc(n: blasint, x: rawptr, incx: blasint, y: rawptr, incy: blasint, ret: rawptr) ---
	cblas_zdotc_sub :: proc(n: blasint, x: rawptr, incx: blasint, y: rawptr, incy: blasint, ret: rawptr) ---

	cblas_sasum :: proc(n: blasint, x: ^f32, incx: blasint) -> f32 ---
	cblas_dasum :: proc(n: blasint, x: ^f64, incx: blasint) -> f64 ---
	cblas_scasum :: proc(n: blasint, x: rawptr, incx: blasint) -> f32 ---
	cblas_dzasum :: proc(n: blasint, x: rawptr, incx: blasint) -> f64 ---
	cblas_ssum :: proc(n: blasint, x: ^f32, incx: blasint) -> f32 ---
	cblas_dsum :: proc(n: blasint, x: ^f64, incx: blasint) -> f64 ---
	cblas_scsum :: proc(n: blasint, x: rawptr, incx: blasint) -> f32 ---
	cblas_dzsum :: proc(n: blasint, x: rawptr, incx: blasint) -> f64 ---

	cblas_snrm2 :: proc(N: blasint, X: ^f32, incX: blasint) -> f32 ---
	cblas_dnrm2 :: proc(N: blasint, X: ^f64, incX: blasint) -> f64 ---
	cblas_scnrm2 :: proc(N: blasint, X: rawptr, incX: blasint) -> f32 ---
	cblas_dznrm2 :: proc(N: blasint, X: rawptr, incX: blasint) -> f64 ---

	cblas_isamax :: proc(n: blasint, x: ^f32, incx: blasint) -> c.size_t ---
	cblas_idamax :: proc(n: blasint, x: ^f64, incx: blasint) -> c.size_t ---
	cblas_icamax :: proc(n: blasint, x: rawptr, incx: blasint) -> c.size_t ---
	cblas_izamax :: proc(n: blasint, x: rawptr, incx: blasint) -> c.size_t ---
	cblas_isamin :: proc(n: blasint, x: ^f32, incx: blasint) -> c.size_t ---
	cblas_idamin :: proc(n: blasint, x: ^f64, incx: blasint) -> c.size_t ---
	cblas_icamin :: proc(n: blasint, x: rawptr, incx: blasint) -> c.size_t ---
	cblas_izamin :: proc(n: blasint, x: rawptr, incx: blasint) -> c.size_t ---
	cblas_samax :: proc(n: blasint, x: ^f32, incx: blasint) -> f32 ---
	cblas_damax :: proc(n: blasint, x: ^f64, incx: blasint) -> f64 ---
	cblas_scamax :: proc(n: blasint, x: rawptr, incx: blasint) -> f32 ---
	cblas_dzamax :: proc(n: blasint, x: rawptr, incx: blasint) -> f64 ---
	cblas_samin :: proc(n: blasint, x: ^f32, incx: blasint) -> f32 ---
	cblas_damin :: proc(n: blasint, x: ^f64, incx: blasint) -> f64 ---
	cblas_scamin :: proc(n: blasint, x: rawptr, incx: blasint) -> f32 ---
	cblas_dzamin :: proc(n: blasint, x: rawptr, incx: blasint) -> f64 ---
	cblas_ismax :: proc(n: blasint, x: ^f32, incx: blasint) -> c.size_t ---
	cblas_idmax :: proc(n: blasint, x: ^f64, incx: blasint) -> c.size_t ---
	cblas_icmax :: proc(n: blasint, x: rawptr, incx: blasint) -> c.size_t ---
	cblas_izmax :: proc(n: blasint, x: rawptr, incx: blasint) -> c.size_t ---
	cblas_ismin :: proc(n: blasint, x: ^f32, incx: blasint) -> c.size_t ---
	cblas_idmin :: proc(n: blasint, x: ^f64, incx: blasint) -> c.size_t ---
	cblas_icmin :: proc(n: blasint, x: rawptr, incx: blasint) -> c.size_t ---
	cblas_izmin :: proc(n: blasint, x: rawptr, incx: blasint) -> c.size_t ---
	...
	cblas_caxpy :: proc(n: blasint, alpha: rawptr, x: rawptr, incx: blasint, y: rawptr, incy: blasint) ---
	cblas_zaxpy :: proc(n: blasint, alpha: rawptr, x: rawptr, incx: blasint, y: rawptr, incy: blasint) ---
	cblas_caxpyc :: proc(n: blasint, alpha: rawptr, x: rawptr, incx: blasint, y: rawptr, incy: blasint) ---
	cblas_zaxpyc :: proc(n: blasint, alpha: rawptr, x: rawptr, incx: blasint, y: rawptr, incy: blasint) ---
	...
	cblas_ccopy :: proc(n: blasint, x: rawptr, incx: blasint, y: rawptr, incy: blasint) ---
	cblas_zcopy :: proc(n: blasint, x: rawptr, incx: blasint, y: rawptr, incy: blasint) ---
	...
	cblas_cswap :: proc(n: blasint, x: rawptr, incx: blasint, y: rawptr, incy: blasint) ---
	cblas_zswap :: proc(n: blasint, x: rawptr, incx: blasint, y: rawptr, incy: blasint) ---
	...
	cblas_csrot :: proc(n: blasint, x: rawptr, incx: blasint, y: rawptr, incY: blasint, _c: f32, s: f32) ---
	cblas_zdrot :: proc(n: blasint, x: rawptr, incx: blasint, y: rawptr, incY: blasint, _c: f64, s: f64) ---
	cblas_srotg :: proc(a: ^f32, b: ^f32, _c: ^f32, s: ^f32) ---
	cblas_drotg :: proc(a: ^f64, b: ^f64, _c: ^f64, s: ^f64) ---
	cblas_crotg :: proc(a: rawptr, b: rawptr, _c: ^f32, s: rawptr) ---
	cblas_zrotg :: proc(a: rawptr, b: rawptr, _c: ^f64, s: rawptr) ---
	...
	cblas_cscal :: proc(N: blasint, alpha: rawptr, X: rawptr, incX: blasint) ---
	cblas_zscal :: proc(N: blasint, alpha: rawptr, X: rawptr, incX: blasint) ---
	cblas_csscal :: proc(N: blasint, alpha: f32, X: rawptr, incX: blasint) ---
	cblas_zdscal :: proc(N: blasint, alpha: f64, X: rawptr, incX: blasint) ---
	...
	cblas_cgemv :: proc(order: CBLAS_ORDER, trans: CBLAS_TRANSPOSE, m: blasint, n: blasint, alpha: rawptr, a: rawptr, lda: blasint, x: rawptr, incx: blasint, beta: rawptr, y: rawptr, incy: blasint) ---
	cblas_zgemv :: proc(order: CBLAS_ORDER, trans: CBLAS_TRANSPOSE, m: blasint, n: blasint, alpha: rawptr, a: rawptr, lda: blasint, x: rawptr, incx: blasint, beta: rawptr, y: rawptr, incy: blasint) ---
	...
	cblas_cgeru :: proc(order: CBLAS_ORDER, M: blasint, N: blasint, alpha: rawptr, X: rawptr, incX: blasint, Y: rawptr, incY: blasint, A: rawptr, lda: blasint) ---
	cblas_cgerc :: proc(order: CBLAS_ORDER, M: blasint, N: blasint, alpha: rawptr, X: rawptr, incX: blasint, Y: rawptr, incY: blasint, A: rawptr, lda: blasint) ---
	cblas_zgeru :: proc(order: CBLAS_ORDER, M: blasint, N: blasint, alpha: rawptr, X: rawptr, incX: blasint, Y: rawptr, incY: blasint, A: rawptr, lda: blasint) ---
	cblas_zgerc :: proc(order: CBLAS_ORDER, M: blasint, N: blasint, alpha: rawptr, X: rawptr, incX: blasint, Y: rawptr, incY: blasint, A: rawptr, lda: blasint) ---
	...
	cblas_ctrsv :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, TransA: CBLAS_TRANSPOSE, Diag: CBLAS_DIAG, N: blasint, A: rawptr, lda: blasint, X: rawptr, incX: blasint) ---
	cblas_ztrsv :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, TransA: CBLAS_TRANSPOSE, Diag: CBLAS_DIAG, N: blasint, A: rawptr, lda: blasint, X: rawptr, incX: blasint) ---
	...
	cblas_ctrmv :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, TransA: CBLAS_TRANSPOSE, Diag: CBLAS_DIAG, N: blasint, A: rawptr, lda: blasint, X: rawptr, incX: blasint) ---
	cblas_ztrmv :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, TransA: CBLAS_TRANSPOSE, Diag: CBLAS_DIAG, N: blasint, A: rawptr, lda: blasint, X: rawptr, incX: blasint) ---
	...
	cblas_cher :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, N: blasint, alpha: f32, X: rawptr, incX: blasint, A: rawptr, lda: blasint) ---
	cblas_zher :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, N: blasint, alpha: f64, X: rawptr, incX: blasint, A: rawptr, lda: blasint) ---
	...
	cblas_cher2 :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, N: blasint, alpha: rawptr, X: rawptr, incX: blasint, Y: rawptr, incY: blasint, A: rawptr, lda: blasint) ---
	cblas_zher2 :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, N: blasint, alpha: rawptr, X: rawptr, incX: blasint, Y: rawptr, incY: blasint, A: rawptr, lda: blasint) ---
	...
	cblas_cgbmv :: proc(order: CBLAS_ORDER, TransA: CBLAS_TRANSPOSE, M: blasint, N: blasint, KL: blasint, KU: blasint, alpha: rawptr, A: rawptr, lda: blasint, X: rawptr, incX: blasint, beta: rawptr, Y: rawptr, incY: blasint) ---
	cblas_zgbmv :: proc(order: CBLAS_ORDER, TransA: CBLAS_TRANSPOSE, M: blasint, N: blasint, KL: blasint, KU: blasint, alpha: rawptr, A: rawptr, lda: blasint, X: rawptr, incX: blasint, beta: rawptr, Y: rawptr, incY: blasint) ---
	...
	cblas_ctbmv :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, TransA: CBLAS_TRANSPOSE, Diag: CBLAS_DIAG, N: blasint, K: blasint, A: rawptr, lda: blasint, X: rawptr, incX: blasint) ---
	cblas_ztbmv :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, TransA: CBLAS_TRANSPOSE, Diag: CBLAS_DIAG, N: blasint, K: blasint, A: rawptr, lda: blasint, X: rawptr, incX: blasint) ---
	...
	cblas_ctbsv :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, TransA: CBLAS_TRANSPOSE, Diag: CBLAS_DIAG, N: blasint, K: blasint, A: rawptr, lda: blasint, X: rawptr, incX: blasint) ---
	cblas_ztbsv :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, TransA: CBLAS_TRANSPOSE, Diag: CBLAS_DIAG, N: blasint, K: blasint, A: rawptr, lda: blasint, X: rawptr, incX: blasint) ---
	...
	cblas_ctpmv :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, TransA: CBLAS_TRANSPOSE, Diag: CBLAS_DIAG, N: blasint, Ap: rawptr, X: rawptr, incX: blasint) ---
	cblas_ztpmv :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, TransA: CBLAS_TRANSPOSE, Diag: CBLAS_DIAG, N: blasint, Ap: rawptr, X: rawptr, incX: blasint) ---
	...
	cblas_ctpsv :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, TransA: CBLAS_TRANSPOSE, Diag: CBLAS_DIAG, N: blasint, Ap: rawptr, X: rawptr, incX: blasint) ---
	cblas_ztpsv :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, TransA: CBLAS_TRANSPOSE, Diag: CBLAS_DIAG, N: blasint, Ap: rawptr, X: rawptr, incX: blasint) ---
	...
	cblas_chemv :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, N: blasint, alpha: rawptr, A: rawptr, lda: blasint, X: rawptr, incX: blasint, beta: rawptr, Y: rawptr, incY: blasint) ---
	cblas_zhemv :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, N: blasint, alpha: rawptr, A: rawptr, lda: blasint, X: rawptr, incX: blasint, beta: rawptr, Y: rawptr, incY: blasint) ---
	...
	cblas_chpr :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, N: blasint, alpha: f32, X: rawptr, incX: blasint, A: rawptr) ---
	cblas_zhpr :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, N: blasint, alpha: f64, X: rawptr, incX: blasint, A: rawptr) ---
	...
	cblas_chpr2 :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, N: blasint, alpha: rawptr, X: rawptr, incX: blasint, Y: rawptr, incY: blasint, Ap: rawptr) ---
	cblas_zhpr2 :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, N: blasint, alpha: rawptr, X: rawptr, incX: blasint, Y: rawptr, incY: blasint, Ap: rawptr) ---

	cblas_chbmv :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, N: blasint, K: blasint, alpha: rawptr, A: rawptr, lda: blasint, X: rawptr, incX: blasint, beta: rawptr, Y: rawptr, incY: blasint) ---
	cblas_zhbmv :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, N: blasint, K: blasint, alpha: rawptr, A: rawptr, lda: blasint, X: rawptr, incX: blasint, beta: rawptr, Y: rawptr, incY: blasint) ---
	cblas_chpmv :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, N: blasint, alpha: rawptr, Ap: rawptr, X: rawptr, incX: blasint, beta: rawptr, Y: rawptr, incY: blasint) ---
	cblas_zhpmv :: proc(order: CBLAS_ORDER, Uplo: CBLAS_UPLO, N: blasint, alpha: rawptr, Ap: rawptr, X: rawptr, incX: blasint, beta: rawptr, Y: rawptr, incY: blasint) ---
	...
	cblas_cgemm :: proc(Order: CBLAS_ORDER, TransA: CBLAS_TRANSPOSE, TransB: CBLAS_TRANSPOSE, M: blasint, N: blasint, K: blasint, alpha: rawptr, A: rawptr, lda: blasint, B: rawptr, ldb: blasint, beta: rawptr, C: rawptr, ldc: blasint) ---
	cblas_cgemm3m :: proc(Order: CBLAS_ORDER, TransA: CBLAS_TRANSPOSE, TransB: CBLAS_TRANSPOSE, M: blasint, N: blasint, K: blasint, alpha: rawptr, A: rawptr, lda: blasint, B: rawptr, ldb: blasint, beta: rawptr, C: rawptr, ldc: blasint) ---
	cblas_zgemm :: proc(Order: CBLAS_ORDER, TransA: CBLAS_TRANSPOSE, TransB: CBLAS_TRANSPOSE, M: blasint, N: blasint, K: blasint, alpha: rawptr, A: rawptr, lda: blasint, B: rawptr, ldb: blasint, beta: rawptr, C: rawptr, ldc: blasint) ---
	cblas_zgemm3m :: proc(Order: CBLAS_ORDER, TransA: CBLAS_TRANSPOSE, TransB: CBLAS_TRANSPOSE, M: blasint, N: blasint, K: blasint, alpha: rawptr, A: rawptr, lda: blasint, B: rawptr, ldb: blasint, beta: rawptr, C: rawptr, ldc: blasint) ---
	...
	cblas_cgemmt :: proc(Order: CBLAS_ORDER, Uplo: CBLAS_UPLO, TransA: CBLAS_TRANSPOSE, TransB: CBLAS_TRANSPOSE, M: blasint, K: blasint, alpha: rawptr, A: rawptr, lda: blasint, B: rawptr, ldb: blasint, beta: rawptr, C: rawptr, ldc: blasint) ---
	cblas_zgemmt :: proc(Order: CBLAS_ORDER, Uplo: CBLAS_UPLO, TransA: CBLAS_TRANSPOSE, TransB: CBLAS_TRANSPOSE, M: blasint, K: blasint, alpha: rawptr, A: rawptr, lda: blasint, B: rawptr, ldb: blasint, beta: rawptr, C: rawptr, ldc: blasint) ---
	...
	cblas_csymm :: proc(Order: CBLAS_ORDER, Side: CBLAS_SIDE, Uplo: CBLAS_UPLO, M: blasint, N: blasint, alpha: rawptr, A: rawptr, lda: blasint, B: rawptr, ldb: blasint, beta: rawptr, C: rawptr, ldc: blasint) ---
	cblas_zsymm :: proc(Order: CBLAS_ORDER, Side: CBLAS_SIDE, Uplo: CBLAS_UPLO, M: blasint, N: blasint, alpha: rawptr, A: rawptr, lda: blasint, B: rawptr, ldb: blasint, beta: rawptr, C: rawptr, ldc: blasint) ---
	...
	cblas_csyrk :: proc(Order: CBLAS_ORDER, Uplo: CBLAS_UPLO, Trans: CBLAS_TRANSPOSE, N: blasint, K: blasint, alpha: rawptr, A: rawptr, lda: blasint, beta: rawptr, C: rawptr, ldc: blasint) ---
	cblas_zsyrk :: proc(Order: CBLAS_ORDER, Uplo: CBLAS_UPLO, Trans: CBLAS_TRANSPOSE, N: blasint, K: blasint, alpha: rawptr, A: rawptr, lda: blasint, beta: rawptr, C: rawptr, ldc: blasint) ---
	...
	cblas_csyr2k :: proc(Order: CBLAS_ORDER, Uplo: CBLAS_UPLO, Trans: CBLAS_TRANSPOSE, N: blasint, K: blasint, alpha: rawptr, A: rawptr, lda: blasint, B: rawptr, ldb: blasint, beta: rawptr, C: rawptr, ldc: blasint) ---
	cblas_zsyr2k :: proc(Order: CBLAS_ORDER, Uplo: CBLAS_UPLO, Trans: CBLAS_TRANSPOSE, N: blasint, K: blasint, alpha: rawptr, A: rawptr, lda: blasint, B: rawptr, ldb: blasint, beta: rawptr, C: rawptr, ldc: blasint) ---
	...
	cblas_ctrmm :: proc(Order: CBLAS_ORDER, Side: CBLAS_SIDE, Uplo: CBLAS_UPLO, TransA: CBLAS_TRANSPOSE, Diag: CBLAS_DIAG, M: blasint, N: blasint, alpha: rawptr, A: rawptr, lda: blasint, B: rawptr, ldb: blasint) ---
	cblas_ztrmm :: proc(Order: CBLAS_ORDER, Side: CBLAS_SIDE, Uplo: CBLAS_UPLO, TransA: CBLAS_TRANSPOSE, Diag: CBLAS_DIAG, M: blasint, N: blasint, alpha: rawptr, A: rawptr, lda: blasint, B: rawptr, ldb: blasint) ---
	...
	cblas_ctrsm :: proc(Order: CBLAS_ORDER, Side: CBLAS_SIDE, Uplo: CBLAS_UPLO, TransA: CBLAS_TRANSPOSE, Diag: CBLAS_DIAG, M: blasint, N: blasint, alpha: rawptr, A: rawptr, lda: blasint, B: rawptr, ldb: blasint) ---
	cblas_ztrsm :: proc(Order: CBLAS_ORDER, Side: CBLAS_SIDE, Uplo: CBLAS_UPLO, TransA: CBLAS_TRANSPOSE, Diag: CBLAS_DIAG, M: blasint, N: blasint, alpha: rawptr, A: rawptr, lda: blasint, B: rawptr, ldb: blasint) ---

	cblas_chemm :: proc(Order: CBLAS_ORDER, Side: CBLAS_SIDE, Uplo: CBLAS_UPLO, M: blasint, N: blasint, alpha: rawptr, A: rawptr, lda: blasint, B: rawptr, ldb: blasint, beta: rawptr, C: rawptr, ldc: blasint) ---
	cblas_zhemm :: proc(Order: CBLAS_ORDER, Side: CBLAS_SIDE, Uplo: CBLAS_UPLO, M: blasint, N: blasint, alpha: rawptr, A: rawptr, lda: blasint, B: rawptr, ldb: blasint, beta: rawptr, C: rawptr, ldc: blasint) ---

	cblas_cherk :: proc(Order: CBLAS_ORDER, Uplo: CBLAS_UPLO, Trans: CBLAS_TRANSPOSE, N: blasint, K: blasint, alpha: f32, A: rawptr, lda: blasint, beta: f32, C: rawptr, ldc: blasint) ---
	cblas_zherk :: proc(Order: CBLAS_ORDER, Uplo: CBLAS_UPLO, Trans: CBLAS_TRANSPOSE, N: blasint, K: blasint, alpha: f64, A: rawptr, lda: blasint, beta: f64, C: rawptr, ldc: blasint) ---
	cblas_cher2k :: proc(Order: CBLAS_ORDER, Uplo: CBLAS_UPLO, Trans: CBLAS_TRANSPOSE, N: blasint, K: blasint, alpha: rawptr, A: rawptr, lda: blasint, B: rawptr, ldb: blasint, beta: f32, C: rawptr, ldc: blasint) ---
	cblas_zher2k :: proc(Order: CBLAS_ORDER, Uplo: CBLAS_UPLO, Trans: CBLAS_TRANSPOSE, N: blasint, K: blasint, alpha: rawptr, A: rawptr, lda: blasint, B: rawptr, ldb: blasint, beta: f64, C: rawptr, ldc: blasint) ---
	...
	cblas_caxpby :: proc(n: blasint, alpha: rawptr, x: rawptr, incx: blasint, beta: rawptr, y: rawptr, incy: blasint) ---
	cblas_zaxpby :: proc(n: blasint, alpha: rawptr, x: rawptr, incx: blasint, beta: rawptr, y: rawptr, incy: blasint) ---
	...
	cblas_comatcopy :: proc(CORDER: CBLAS_ORDER, CTRANS: CBLAS_TRANSPOSE, crows: blasint, ccols: blasint, calpha: ^f32, a: ^f32, clda: blasint, b: ^f32, cldb: blasint) ---
	cblas_zomatcopy :: proc(CORDER: CBLAS_ORDER, CTRANS: CBLAS_TRANSPOSE, crows: blasint, ccols: blasint, calpha: ^f64, a: ^f64, clda: blasint, b: ^f64, cldb: blasint) ---
	...
	cblas_cimatcopy :: proc(CORDER: CBLAS_ORDER, CTRANS: CBLAS_TRANSPOSE, crows: blasint, ccols: blasint, calpha: ^f32, a: ^f32, clda: blasint, cldb: blasint) ---
	cblas_zimatcopy :: proc(CORDER: CBLAS_ORDER, CTRANS: CBLAS_TRANSPOSE, crows: blasint, ccols: blasint, calpha: ^f64, a: ^f64, clda: blasint, cldb: blasint) ---
	...
	cblas_cgeadd :: proc(CORDER: CBLAS_ORDER, crows: blasint, ccols: blasint, calpha: ^f32, a: ^f32, clda: blasint, cbeta: ^f32, _c: ^f32, cldc: blasint) ---
	cblas_zgeadd :: proc(CORDER: CBLAS_ORDER, crows: blasint, ccols: blasint, calpha: ^f64, a: ^f64, clda: blasint, cbeta: ^f64, _c: ^f64, cldc: blasint) ---
